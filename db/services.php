...
$functions = [
    'block_my_day_buttons_get_timetable_html_for_date' => [
    'classname' => 'block_my_day_buttons\external\api', // Class containing a reference to the external function.
    ...
    'block_my_day_buttons_get_timetable_data_for_date' => [
        'classname' => 'block_my_day_buttons\external\api', // Class containing a reference to the external function.
